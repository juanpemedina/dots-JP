describe('Registro de Movimientos', () => {
  ...
  it.skip('Prueba con todos los datos de salida', () => {
  ...
  it.skip('Prueba con todos los datos de entrada', () => {
  ...
  it.skip('Prueba con todos los datos de entrada, con el donador en null', () => {
