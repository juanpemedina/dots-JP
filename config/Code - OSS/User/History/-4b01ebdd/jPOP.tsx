  ...
  <Popover.Root>
    ...
    <Popover.Portal>
      <Popover.Content
        ...
        <Popover.Close
          className="rounded-full h-[25px] w-[25px] inline-flex items-center justify-center text-violet11 absolute top-[15px] right-[15px] hover:bg-violet4 focus:shadow-[0_0_0_2px] focus:shadow-violet7 outline-none cursor-default z-[1]"
          aria-label="Close"
        >
          <Cross2Icon />
        </Popover.Close>
