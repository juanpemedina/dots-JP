...
const PopoverRadix = () => (
  <Popover.Root>
    <Popover.Trigger asChild>
      <button
        className="rounded-full w-[35px] h-[35px] inline-flex items-center justify-center text-violet11 bg-green-800 shadow-[0_2px_10px] shadow-blackA4 hover:bg-violet3 focus:shadow-[0_0_0_2px] focus:shadow-black cursor-default outline-none"
        aria-label="Update dimensions"
      >
        <QuestionMarkIcon className='fill-white'/>
      </button>
    </Popover.Trigger>
    <Popover.Portal>
      <Popover.Content
