...
df_sum_hours = df_cleaned_final.groupby(['Employee', 'Employee GPN','Rank Description', 'Employee Service Line', 'Employee Sub Service Line', 'Employee Competency', 'Engagement', 'Engagement ID', 'Client Name'])['Hours'].sum().reset_index()
