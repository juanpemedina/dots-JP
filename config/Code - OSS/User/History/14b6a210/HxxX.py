...
df_sum_hours_weekly = df_cleaned_final.groupby(['Employee GPN', 'Employee', 'Engagement ID', 'Engagement', 'Engagement Type', 'Accounting Cycle Date'])['Hours'].sum().reset_index()
