...
function App() {
  ...
  const [authenticatedRouter, setAuthenticatedRouter] = useState<JSX.Element | null>(null);
  ...
  useEffect(() => {
    ...
    if (currentPath === "/login") {
      setIsAdmin(false);
      setAuthenticatedRouter(<RouterProvider router={router} />);
      return;
    }
    ...
    const authenticate = async () => {
      try {
        ...
        setIsAdmin(isAdmin);
        setAuthenticatedRouter(<RouterProvider router={isAdmin ? routerAdmin : router} />);
      } catch (error) {
  ...
  if (isAdmin === null || authenticatedRouter === null) {
