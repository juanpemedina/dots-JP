...
df_cleaned = df_cleaned[df_cleaned['Accounting Cycle Date'].dt.year >= 2024]
...
df_engagement_with_budget = pd.merge(df_engagement_sum, df_budget_cleaned, on='Engagement ID', how='left')
