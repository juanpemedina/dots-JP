...
class IsAdministratorOrVolunteer(BasePermission):
    def has_permission(self, request, view):
        user = request.user
        if user.is_authenticated:
            return user.is_administrator or user.is_volunteer
        return False

# Example protected view
class MyProtectedView(generics.RetrieveAPIView):
    permission_classes = [IsAdministratorOrVolunteer]
