...
def test_addDrink():
    ...
    assert addDrink("Cafe,10,12,14,16,18") ==  "The drink [Cafe] with the sizes [10, 12, 14, 16, 18] were added to stock"

    # Test 2 a 15 caracteres de longitud
    assert addDrink("Lechero,10,12,14,16,18") == "Se ha agregado la bebida Lechero con los tamaños 10, 12, 14, 16, 18."
