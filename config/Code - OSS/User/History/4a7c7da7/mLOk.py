...
def test_addDrink():
    ...
    assert addDrink("IceCoffee,5,10,14") == "The drink [IceCoffee] with the sizes [ 5, 10, 14], was added to stock"
    ...
    assert addDrink("Cortado,10,12,14") == "The drink [Expresso] with the sizes [10, 12, 14, 16, 18], was added to stock"

    assert addDrink("Latte,8,12,16") == "The drink [Expresso] with the sizes [10, 12, 14, 16, 18], was added to stock"
