...
const FooterContact: React.FC = () => {
  return (
    <div className="bg-orange-500 text-white p-10 flex flex-col md:flex-row justify-between">
      <div className="flex justify-center items-start flex-col mt-2 md:mt-4">
      ...
      <div className="flex justify-center items-start flex-row mt-2 md:mt-4">
        <div className="mx-5 md:ml-14">
