			...
			<Tabs.Root defaultValue="tab1">
				<div className="m-8">
					<Tabs.List className="flex gap-4" aria-label="Seleccionar movimiento">
						...
						<Tabs.Trigger
							className="tab2 border-2 border-accent-green rounded-md p-2 data-[state=active]:text-white data-[state=active]:bg-accent-green"
							value="tab2"
				...
				<div className="flex flex-col items-center">
					...
					<Tabs.Content value="tab2">
						<div className="tab2 flex flex-col items-end" id="tab2">
							<Incomings />
						</div>
					</Tabs.Content>
